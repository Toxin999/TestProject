...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "c0183b04-10f9-4974-b47a-ee3592c68b2a",
...
const _KDvuCs = lazyEventHandler(() => {
...
const _lazy_HBl7Xq = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_HBl7Xq, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _KDvuCs, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_HBl7Xq, lazy: true, middleware: false, method: undefined }
];
